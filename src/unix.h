...
#define CODE_DISCONNECT 12                  // Client requests to disconnect from the server
...
#define CODE_REQUEST_COMPETITION_JOIN 30    // Client requests to join a competitive multiplayer game
#define CODE_REQUEST_STATS 40               // Client requests game statistics, such as fastest completion time or records
...
#define CODE_RESPONSE_ERROR 400             // Server responds indicating an error occurred
...
#define CODE_NOTIFY_NEW_COMPETITOR 120      // Server notifies the client when a new competitor joins the game
#define CODE_NOTIFY_COMPETITION_WINNER 121  // Server announces the winner of a multiplayer game

// Statistics and Logs
#define CODE_RESPONSE_STATS 130             // Server provides the requested game statistics to the client

// Error and Control Codes
#define CODE_RESPONSE_INVALID_COMMAND 500   // Server notifies the client of an unrecognized or unsupported command
